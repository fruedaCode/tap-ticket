...
// the session in the URL fragment, before any cookie exists); '/en' is the
// English landing — public so crawlers can index it.
const PUBLIC_PATHS = ['/login', '/auth', '/plans', '/legal', '/api/billing/webhook', '/join', '/en']
